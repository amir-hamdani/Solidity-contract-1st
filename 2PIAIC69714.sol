...
// Step 1: The owner of bank account can start the bank with min 50 eths initial deposit.
   modifier onlyOwner {
...
// Step 2: Only the owner can close the bank. Upon closing the balance should return to the Owner account.
   modifier onlyOwner2{
